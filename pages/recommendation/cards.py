"""Recommendation System — Shared product card HTML."""
...
def item_card_html(item: Item, selected: bool = False) -> str:
    """Unified product card used in both input and output views.
    ...
    selected:
        When True, shows a "Selected" badge and highlights the border.
    """
    ...
    badge_html = (
        ...
        'padding:2px 8px;border-radius:12px;font-weight:bold;">✓ Selected</span>'
        if selected else ""
    )
...
def compact_card_html(item: Item) -> str:
    """Compact horizontal card for non-recommended products."""
    return f"""
<div style="
...
">
  ...
  <span style="font-size:11px;color:#aaa;white-space:nowrap;">Not Selected</span>
</div>
"""
